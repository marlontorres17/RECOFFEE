    ...
    public partial class coffee : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_roles_views", x => x.Id);
                    table.ForeignKey(
                        name: "FK_roles_views_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_roles_views_views_ViewId",
                        column: x => x.ViewId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalKilo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalBenefit = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalPay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PersonId = table.Column<int>(type: "int", nullable: false),
                    State = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SizeMeters = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Image = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    FarmId = table.Column<int>(type: "int", nullable: false),
                    State = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KiloPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_roles_views_RoleId",
                table: "roles_views",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_roles_views_ViewId",
                table: "roles_views",
                column: "ViewId");
